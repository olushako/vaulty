"""
Cross-platform device identifier generator
Uses: hash(pwd) + hash(hostname) + MAC
All concatenated and hashed together for deterministic device ID
Works across Linux, macOS, Windows, and containers
"""
...
def get_device_id_hash(device_id: str = None) -> str:
    """Backward compatibility alias for get_device_token"""
    return get_device_token(device_id)
