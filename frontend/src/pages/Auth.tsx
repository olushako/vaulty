    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="card p-8 w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Vaulty</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Secrets Manager</p>
        </div>
